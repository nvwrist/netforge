...
export const TUNE = {
  ...
  nodeCapPerLevel: 0.25,  // +25% capacity/buffer per node level (storage/transfer)
  nodeDrainPerLevel: 0.1, // +10% reserve drain per node level (storage)
  nodeMaxLevel: 5,
  offlineCapHours: 8,
...
const RU: Record<string, string> = {
  ...
  'info.output': 'Выход', 'info.cap': 'Вместимость', 'info.drainPlus': '+10% дренаж',
  ...
  'codex.lvl.generator': 'Уровни: −{t}% время цикла, +{q}% выход',
  'codex.lvl.processor': 'Уровни: −{t}% время цикла, +{q}% выход',
  'codex.lvl.storage': 'Уровни: +{c}% вместимость, +{d}% дренаж в резерв',
  'codex.lvl.transfer': 'Уровни: +{c}% буфер передачи',
  'faq.q13': 'Что даёт улучшение (уровень) узла?',
  'faq.a13': 'Генераторам и процессорам: −15% время цикла и +25% выход за уровень. Хранилищам: +25% вместимость и +10% скорость дренажа. Маршрутизаторам, хабам и кэшам: +25% буфер передачи. Максимальный уровень — 5. Точный эффект следующего уровня виден в панели выбранного узла.',
...
const EN: Record<string, string> = {
  ...
  'info.output': 'Output', 'info.cap': 'Capacity', 'info.drainPlus': '+10% drain',
  ...
  'codex.lvl.generator': 'Levels: −{t}% cycle time, +{q}% output',
  'codex.lvl.processor': 'Levels: −{t}% cycle time, +{q}% output',
  'codex.lvl.storage': 'Levels: +{c}% capacity, +{d}% reserve drain',
  'codex.lvl.transfer': 'Levels: +{c}% transfer buffer',
  'faq.q13': 'What does a node upgrade (level) do?',
  'faq.a13': 'Generators and processors: −15% cycle time and +25% output per level. Storages: +25% capacity and +10% drain speed. Routers, hubs and caches: +25% transfer buffer. Max level is 5. The exact next-level effect is shown in the selected node panel.',
